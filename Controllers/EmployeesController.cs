...
namespace CoreGCP.Controllers
{
    public class EmployeesController : Controller
    {
        private readonly GcpCoreContext _context;

        public EmployeesController(GcpCoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int? id)
        {
            ...
            {
                return Problem("Entity set 'GcpCoreContext.Employees'  is null.");
            }
            var employee = await _context.Employees.FindAsync(id);
            if (employee != null)
            {
